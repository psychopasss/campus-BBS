...
<div id="content"  align="left" >
		<s:form action="tzfindByKeywordAnswer?bbsSender=%{#session.user}" >
		...
		<table  class="t" id="theTable" >
			<thead>
			<tr class="t">	
				<th class="t" width="70%">回复内容</th>
				<th class="t" width="10%">回复楼层</th>
				<th class="t" width="15%">回复时间</th>
				<th class="d" width="5%">操作</th>	
			</tr>	
			</thead>
			<s:if test="ul1 == null">
			...
			<tr class="t">
				<td class="t">&nbsp;<a href="tzdetail?h=<s:property value="bbsAnswerId"/>" ><s:property value="bbsAnswerContent"/></a></td>
				<td class="t">&nbsp;<s:property value="bbsAnswerFloorid"/>#</td>
				<td class="t">&nbsp;<s:property value="bbsAnswerSendTime"/></td>
				<td class="t">
					<div align="center">
					<a href="tzupdateAnswer2?bbsAnswerId=<s:property value="bbsAnswerId"/>&bbsAnswerFloorid=<s:property value="bbsAnswerFloorid"/>" >编辑</a>
					<a href="tzdeleteAnswer?bbsAnswerId=<s:property value="bbsAnswerId"/>&bbsAnswerFloorid=<s:property value="bbsAnswerFloorid"/>&bbsSender=${user}" onclick="return ConfirmDel();">删除</a>	
					</div>				
				</td>		
			</tr>
			</s:iterator>	
